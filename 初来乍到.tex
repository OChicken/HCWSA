...
\section{申请居留许可}\label{sec:申请居留许可}
  ...
  \subsection{找工作签证}
    ...
    \begin{enumerate}
      ...
      \item ``找工作签证''有多长时限?\\
      答：德国政府也是希望在德国高校毕业的学生能留在德国工作，就业环境比较宽松，所以找工作签证从 12 到 18 个月不等。但通常，在提交毕业论文到论文出成绩就有 8 周的时间。此外，不少研究组织和公司虽然在招聘信息里写着``需要提交毕业证''，实际上在毕业论文的末期也可以申请。这些时间加起来足够去写申请和找工作了。所以申请 \textsbf{Fiktionsbescheinigung} 也是可以的。
